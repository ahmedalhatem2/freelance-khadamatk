      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="glass p-2 rounded-full flex items-center opacity-0 animate-fade-in animate-delay-500">
            ...
            <div className="mt-8 text-sm text-muted-foreground flex items-center gap-6 opacity-0 animate-fade-in animate-delay-500">
              <div className="flex -space-x-3 space-x-reverse">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-8 h-8 rounded-full bg-gray-200 border-2 border-background flex items-center justify-center">
            ...
            <div className="relative">
              ...
              <div className="glass rounded-2xl overflow-hidden shadow-xl">
                <img 
                  ...
                  className="w-full object-cover object-center h-96 md:h-[450px]"
                />
              </div>
            </div>
          </div>
